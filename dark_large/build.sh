...
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/close_button_active.png \
-background none -layers merge +repage temp/close-active.png

convert \
-page +0+0 src/title_active.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/maximize_button_active.png \
-background none -layers merge +repage temp/maximize-active.png

convert \
-page +0+0 src/title_active.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/minimize_button_active.png \
-background none -layers merge +repage temp/hide-active.png

convert \
-page +0+0 src/title_active.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/maximize_toggled_button_active.png \
-background none -layers merge +repage temp/maximize-toggled-active.png

convert \
-page +0+0 src/title_active.png \
-page +11+${VMAR_BUTTON_FG} ../common_src/dark/menu_button_active.png \
-define png:color-type=6 -background none -layers merge +repage temp/menu-active.png

convert \
-page +0+0 src/title_active.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/stick_button_active.png \
-define png:color-type=6 -background none -layers merge +repage temp/stick-active.png

convert \
-page +0+0 src/title_active.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/shade_button_active.png \
...
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG_INACTIVE} ../common_src/dark/close_button_inactive.png \
-background none -layers merge +repage temp/close-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG_INACTIVE} ../common_src/dark/maximize_button_inactive.png \
-background none -layers merge +repage temp/maximize-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG_INACTIVE} ../common_src/dark/minimize_button_inactive.png \
-background none -layers merge +repage temp/hide-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG_INACTIVE} ../common_src/dark/maximize_toggled_button_inactive.png \
-background none -layers merge +repage temp/maximize-toggled-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +11+${VMAR_BUTTON_FG} ../common_src/dark/menu_button_inactive.png \
-background none -layers merge +repage temp/menu-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/stick_button_inactive.png \
-background none -layers merge +repage temp/stick-inactive.png

convert \
-page +0+0 src/title_inactive.png \
-page +${HMAR_BUTTON_FG}+${VMAR_BUTTON_FG} ../common_src/dark/shade_button_inactive.png \
