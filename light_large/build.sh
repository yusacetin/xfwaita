...
convert \
-page +0+0 src/title_active.png \
-page +11+${VMAR_BUTTON_FG} ../common_src/light/menu_button_active.png \
...
convert \
-page +0+0 src/title_inactive.png \
-page +11+${VMAR_BUTTON_FG} ../common_src/light/menu_button_inactive.png \
...
cp ../common_src/light/bottom_active.png temp/bottom-active.png
cp ../common_src/light/bottom_inactive.png temp/bottom-inactive.png

# Right window border
cp ../common_src/light/right_active.png temp/right-active.png
cp ../common_src/light/right_inactive.png temp/right-inactive.png

# Left window border
cp ../common_src/light/left_active.png temp/left-active.png
cp ../common_src/light/left_inactive.png temp/left-inactive.png

# Bottom right window border
cp ../common_src/light/bottom_right_active.png temp/bottom-right-active.png
cp ../common_src/light/bottom_right_inactive.png temp/bottom-right-inactive.png

# Bottom left window border
cp ../common_src/light/bottom_left_active.png temp/bottom-left-active.png
cp ../common_src/light/bottom_left_inactive.png temp/bottom-left-inactive.png
